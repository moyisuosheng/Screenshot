// dear layers: Platform Backend for GLFW
...
//   (passing install_callbacks=false in ImGui_ImplGlfw_InitXXX functions), set the current dear layers context and then call our callbacks.
...
static void ImGui_ImplGlfw_UpdateMouseCursor()
{
    ...
    // (those braces are here to reduce diff with multi-viewports support in 'docking' branch)
    {
        ...
        {
            // Hide OS mouse cursor if layers is drawing it or if it wants no cursor
