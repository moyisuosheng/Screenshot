...
//   - Read 'Programmer guide' in layers.cpp for notes on how to setup Dear ImGui in your codebase.
// Read layers.cpp for more details, documentation and comments.
...
//   by layers.h using the IMGUI_DEFINE_MATH_OPERATORS define. For your own sources file they are optional
...
// In other layers sources we can use nicer internal functions from imgui_internal.h (ImMin/ImMax) but not in the demo.
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    ImGui::Text("dear layers says hello! (%s) (%d)", IMGUI_VERSION, IMGUI_VERSION_NUM);
    ImGui::Spacing();
    ...
    if (ImGui::CollapsingHeader("Help"))
    {
        ...
        ImGui::BulletText("See comments in layers.cpp.");
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Enable gamepad controls. Require backend to set io.BackendFlags |= ImGuiBackendFlags_HasGamepad.\n\nRead instructions in layers.cpp for details.");
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Text Input"))
    {
        ...
        if (ImGui::TreeNode("Filtered Text Input"))
        {
            struct TextFilters
            {
                ...
                {
                    if (data->EventChar < 256 && strchr("layers", (char)data->EventChar))
                        return 0;
                    return 1;
                }
            };
            ...
            static char buf7[32] = ""; ImGui::InputText("\"layers\"",   buf7, 32, ImGuiInputTextFlags_CallbackCharFilter, TextFilters::FilterImGuiLetters); // Use CharFilter callback to disable some characters.
            ImGui::TreePop();
        }
    ...
    if (ImGui::TreeNode("Data Types"))
    {
        ...
        ImGui::SameLine(); HelpMarker(
            "As with every widget in dear layers, we never modify values unless there is a user interaction.\n"
...
static void ShowDemoWindowPopups()
{
    ...
    if (ImGui::TreeNode("Modals"))
    {
        ...
        if (ImGui::BeginPopupModal("Stacked 1", NULL, ImGuiWindowFlags_MenuBar))
        {
            ...
            // will close the popup. Note that the visibility state of popups is owned by layers, so the input value
...
struct MyItem
{
    ...
    // As we don't rely on std:: or other third-party library to compile dear layers, we only have reliable access to qsort(),
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    // types and ImVec2/ImVec4. Dear ImGui defines overloaded operators but they are internal to layers.cpp and not
