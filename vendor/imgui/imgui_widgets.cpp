...
// See the series of events below and the corresponding state reported by dear layers:
//------------------------------------------------------------------------------------------------------------------------------------------------
...
{
    // Read layers.cpp "API BREAKING CHANGES" section for 1.78 if you hit this assert.
